window.onload = function(){
    ...
    function enter_transaction(){
        chrome.storage.sync.get('balance',function(o1){
          ...
          document.getElementById('balance').innerHTML = abs(parseInt(new_val));
    ...
    function reset_limit(){
      chrome.storage.sync.get('balance',function(obj){
        ...
        document.getElementById('balance').innerHTML = abs(parseInt(y));
    ...
    function reset_bal(){
      ...
      document.getElementById('balance').innerHTML = abs(parseInt(x));
